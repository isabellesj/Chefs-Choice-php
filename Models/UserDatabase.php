...
class UserDatabase
{
  ...
  function seedUsers()
  {
    ...
    if ($this->pdo->query("select * from users where email='isabelle.sj@live.se'")->rowCount() == 0) {
      $userId = $this->auth->admin()->createUser("isabelle.sj@live.se", "hejsan123", "isabelle.sj@live.se");
